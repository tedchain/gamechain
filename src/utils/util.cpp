...
#include "gamechain/gamechain.h"                                              // MCHN
...
/* MCHN START */
static boost::filesystem::path pathCachedgamechain;
...
/* MCHN START */
    ...
    pathCachedgamechain=fs::path(string(mc_gState->m_Params->DataDir()));
    fs::path &path =pathCachedgamechain;
    return path;
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "gamechain.pid"));
