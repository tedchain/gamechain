...
bool ParsegamechainTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
...
bool ParsegamechainTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
                                  ...
                                  string& strFailReason)                        // OUT error
{
    return ParsegamechainTxOutToBuffer(hash,txout,amounts,lpScript,allowed,required,NULL,strFailReason);
}
