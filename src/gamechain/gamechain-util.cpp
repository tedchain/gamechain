...
int main(int argc, char* argv[])
{
    ...
    mc_gamechainParams* params;
    mc_gamechainParams* paramsOld;
...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running gamechaind for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"gamechaind %s -daemon\".\n",params->Name());
                }                
                else
                {
        ...
        if(strcmp(mc_gState->m_Params->Command(),"clone") == 0)
        {
            ...
            {
                params=new mc_gamechainParams;
                paramsOld=new mc_gamechainParams;
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  gamechain-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new gamechain configuration file %s with default parameters\n",
        ...
        printf("  gamechain-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new gamechain configuration file %s copying parameters\n",fileName);
