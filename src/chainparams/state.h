...
#ifndef GAMECHAIN_STATE_H
#define	GAMECHAIN_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/gamechainscript.h"
...
{    
    const mc_OnegamechainParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_gamechainParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_gamechainParams;
        m_Permissions=NULL;
        m_Assets=NULL;
