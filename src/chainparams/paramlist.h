...
#ifndef GAMECHAINPARAMLIST_H
#define GAMECHAINPARAMLIST_H

static const mc_OnegamechainParam gamechainParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: gamechain (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for gamechaind and gamechain-cli."},                   
